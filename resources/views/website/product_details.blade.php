                    ...
                    <ul class="small-product">
                        <li>
                            <a href="#" title="Praesent tempor sem sodales">
                                <img src="{{asset('website/themes/images/ladies/1.jpg')}}" alt="Praesent tempor sem sodales">
                            </a>
                            <a href="#">Praesent tempor sem</a>
                        </li>
                        <li>
                            <a href="#" title="Luctus quam ultrices rutrum">
                                <img src="{{asset('website/themes/images/ladies/2.jpg')}}" alt="Luctus quam ultrices rutrum">
                            </a>
                            <a href="#">Luctus quam ultrices rutrum</a>
                        </li>
                        <li>
                            <a href="#" title="Fusce id molestie massa">
                                <img src="{{asset('website/themes/images/ladies/3.jpg')}}" alt="Fusce id molestie massa">
                            </a>
